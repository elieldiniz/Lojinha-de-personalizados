...
export default function FormLoginAuth() {
  return (
    <div 
    ...
    >
      <div className="flex flex-col justify-center items-center w-full max-w-sm p-6 bg-opacity-10 backdrop-blur-md rounded-lg shadow-lg relative">
        ...
        <div className="flex flex-col gap-4 w-full mt-6">
          ...
          <button 
            type="button"
            className="w-full py-2 border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white font-semibold rounded-lg transition-all duration-200"
          >
            Criar Usuário
          </button>
        </div>
